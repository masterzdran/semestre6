...
*/
            ...
            System.Console.WriteLine("\n\nTeste ExecuteScalar");
            cn.Open();
            cmd =  new SqlCommand("Select Count(*) from alunos where numero = 11406", cn);
            ...
            // -------------------------------------------------------------------------------------------------------------------------------------
            /* Test that represents in ado.net this codig in sql server
            ...
            catch (Exception e) 
            {
	            ...
	            Console.WriteLine("Ocorreu a excepcao " + e.GetType() +
		              " ao inserir os registos."+e.Message);
