...
create table EMPLOYEE(
	...
	constraint fk_EMPLOYEE2 foreign key (RESTAUNRANT_ID) references RESTAURANTS(ID)
)

create table EMPLOYEE_PROFICIENCY(
	PROFICIENCY_ID		int not null,
	EMPLOYEE_ID			int not null,
	constraint pk_EMPLOYEE_PROFICIENCY1 primary key (PROFICIENCY_ID, EMPLOYEE_ID),
	constraint fk_EMPLOYEE_PROFICIENCY1 foreign key (PROFICIENCY_ID) references PROFICIENCY(ID),
...
create table COMMENTS(
	...
	constraint	fk_COMMENTS1 foreign key(CUSTOMER_ID) references CUSTOMER(PERSON_ID),
...
create table REGISTERED(
	...
	constraint	fk_REGISTERED1 foreign key (CUSTOMER_ID) references CUSTOMER(PERSON_ID),
...
create table BOOKING(
	...
	constraint	fk_BOOKING foreign key(CUSTOMER_ID) references CUSTOMER(PERSON_ID),
)
...
create table LOT(
	...
	constraint fk_LOT2 foreign key(RESTAURANT_ID) references RESTAURANTS(ID)
)
...
create table ORDERS(
	...
	constraint fk_ORDERS3 foreign key(RESTAURANT_ID) references RESTAURANTS(ID)
)
...
create table ORDERS_LOG(
	...
	constraint fk_ORDERS_LOG4 foreign key(RESTAURANT_ID) references RESTAURANTS(ID)
)
...
create table EVENT_FRIENDS(
	...
	constraint fk_EVENT_FRIENDS1 foreign key(CUSTOMER_ID) references CUSTOMER(PERSON_ID)
)
