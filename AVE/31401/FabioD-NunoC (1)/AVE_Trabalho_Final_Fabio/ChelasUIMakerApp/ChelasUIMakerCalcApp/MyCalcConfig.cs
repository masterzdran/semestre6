...
namespace ChelasUIMakerCalcApp
{
    ...
    internal class MyCalcConfig : Config
    {
        protected override void LoadConfig()
        {
            ...
            var area1 = DefineArea<Panel>(p => { p.Height = 70; p.Width = 280; p.BackColor = Color.Gray; }) // p.Height=100;
            ...
            var area2 = DefineArea<Panel>(p => { p.Name="operations"; p.Top=70; p.Width=280; p.Height=100; p.SetBackColor(0x30FFFF30); })
            ...
            var area3 = DefineArea<Panel>(p => { p.Top = 170; p.Width = 280; p.Height=200; p.BackColor=Color.Gray; })
                ...
                .WithContent<Button>(DefineArea<Button>(b6 => { b6.Text = "6"; b6.Top=50; b6.Left=200; b6.ForeColor = Color.White; })) // original: b6.Left=100;
                ...
                .WithContent<Button>(DefineArea<Button>(bC => { bC.Text = "C"; bC.Top=150; bC.Left=100; bC.ForeColor = Color.White; })); // original: bC.Left=200;

            DefineArea<Form>(f => { f.Text = "Calculadora"; f.Height = 390;f.Width=285; })
